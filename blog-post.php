...
$query_mostRead  = "SELECT p.* 	FROM posts p LEFT JOIN categoris c ON p.category_id = c.id WHERE p.category_id=			" .$id_cate. " ORDER BY P.created_at DESC LIMIT 5";
					...
					<div class="col-md-8">
						<div class="section-row sticky-container">
							<div class="main-post">
								...
								<p><b><em> ĐĂNG BỞI: <?=$post['name']?>  </em></b></p> <!-- nguoi dang -->
					...
					<div class="col-md-4">
						...
						<div class="aside-widget">
							...
							<div class="post post-widget">
								<a class="post-img" href="blog-post.html"><img src="<?php echo $read_same_cate['thumbnail'] ?>" alt=""></a>
								<div class="post-body">
									<h3 class="post-title"><a href="blog-post.html"><?=$read_same_cate['title']?></a></h3>
								</div>
							</div>
						<?php } ?>
